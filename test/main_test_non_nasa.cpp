...
#include <iostream>
#include <cassert>
#include "../components/samsung_hp/util.h"
#include "../components/samsung_hp/protocol.h"
#include "../components/samsung_hp/non_nasa.h"

using namespace std;
using namespace esphome::samsung_hp;
